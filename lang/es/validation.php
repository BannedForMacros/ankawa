...
return [
    ...
    'attributes' => [
        ...
        'email_demandado'          => 'correo del demandado',
        'telefono_demandado'       => 'teléfono del demandado',
        'resumen_controversia'     => 'resumen de la controversia',
        'pretensiones'             => 'pretensiones',
        'monto_involucrado'        => 'monto involucrado',
        'nombre_arbitro_propuesto' => 'nombre del árbitro propuesto',
        'email_arbitro_propuesto'  => 'correo del árbitro propuesto',
        'domicilio_arbitro_propuesto' => 'domicilio del árbitro propuesto',
        'reglas_aplicables'        => 'reglas aplicables',
        'documentos_controversia'  => 'documentos de controversia',
