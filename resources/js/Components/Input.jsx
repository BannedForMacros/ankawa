        ...
        <div className="mb-5">
            ...
            <input
                ...
                className={`w-full px-4 py-2.5 text-sm border rounded-xl bg-white
                    ...
                    transition-all text-[#291136] placeholder-gray-400
                    disabled:bg-[#BE0F4A]/5 disabled:border-[#BE0F4A]/30 disabled:text-[#BE0F4A] disabled:font-semibold disabled:cursor-not-allowed
