    ...
    <div class="container">
        ...
        <div class="body">
            ...
            <p style="color:#555; font-size:14px; line-height:1.6;">
                Estimado/a <strong>{{ $solicitud->nombre_remitente }}</strong>, su documento ha sido recibido y registrado.
            </p>
            ...
            <div style="margin: 24px 0;">
                ...
                <div class="dato">
                    ...
                    <span class="dato-valor">{{ $solicitud->tipoDocumento->nombre }}</span>
                </div>
                <div class="dato">
                    <span class="dato-label">Remitente</span>
