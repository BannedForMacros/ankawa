...
class MovimientoController extends Controller
{
    ...
    public function store(Request $request, Expediente $expediente)
    {
        ...
        $request->validate([
            ...
            'requerimientos.*.traslado_auto.disparadores_actor_ids'                           => 'required_with:requerimientos.*.traslado_auto|array|min:1',
            'requerimientos.*.traslado_auto.disparadores_actor_ids.*'                         => ['integer', $existsActorEnExpediente],
            'requerimientos.*.traslado_auto.destinatarios_actor_ids'                          => 'required_with:requerimientos.*.traslado_auto|array|min:1',
            'requerimientos.*.traslado_auto.destinatarios_actor_ids.*'                        => ['integer', $existsActorEnExpediente],
            'requerimientos.*.traslado_auto.genera_requerimiento_auto'                        => 'nullable|boolean',
            'requerimientos.*.traslado_auto.requerimiento_auto_config.tipo_documento_id'      => ['nullable', $existsTipoDocEnServicio],
            'requerimientos.*.traslado_auto.requerimiento_auto_config.dias_plazo'             => 'nullable|integer|min:1|max:365',
            'requerimientos.*.traslado_auto.requerimiento_auto_config.tipo_dias'              => 'nullable|in:calendario,habiles',
            'requerimientos.*.traslado_auto.requerimiento_auto_config.responsable_actor_id'   => ['nullable', 'integer', $existsActorEnExpediente],
