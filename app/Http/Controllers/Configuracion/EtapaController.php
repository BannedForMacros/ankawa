...
public function index(Request $request)
                  ...
                  ->with(['actividades' => function ($q2) {
                      ...
                      $q2->orderBy('orden')
                         ->with([
                             ...
                             'transiciones.requisitoDocumento',
    ...
    public function storeTransicion(Request $request, \App\Models\Actividad $actividad)
    {
        $request->validate([
            ...
            'requisito_documento_id'                => 'nullable|exists:actividad_requisitos_documento,id',
        ...
        $transicion = \App\Models\ActividadTransicion::create([
            ...
            'requisito_documento_id'   => $request->requisito_documento_id,
